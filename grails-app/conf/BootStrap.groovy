...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		new Beer(beerName:'Choufe',presentation:'Grosse cuite, petit prix',price:5.15,quantity:200,photoName:"chouffe.jpg").save()
		new Beer(beerName:'Cuvée des Trolls',presentation:'Même les moches ont le droit de boire.',price:5.45,quantity:200,photoName:"rince.jpg").save()
